...
Cross-cutting:
    ...
    /wize-no-ai-slop            Writing hygiene for end-user-facing prose: removes
                                AI-slop patterns and filler while preserving the
                                writer's voice. Detects slop on request.
